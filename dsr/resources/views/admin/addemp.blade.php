                                    ...
                                    @endif
                                     ...
                                     <div class="col-lg-6">      
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::number('emp_id', null, ['class'=>'form-control', 'id'=>'emp_id']) !!}                                            
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('user_tag[]',$tagsDropdown, [], ['class'=>'form-control', 'id'=>'user_tags','multiple'=>'multiple']) !!}
                                        </div> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('leaves_allotted', null, ['class'=>'form-control', 'id'=>'leave_allotted']) !!}                                                  
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('title', 'Leave Forwarded') !!}
                                            {!! Form::text('leaves_forward', null, ['class'=>'form-control', 'id'=>'leave_forwarded']) !!}                                                  
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('title', 'Other Leave') !!}
                                            {!! Form::text('other_leaves_allotted', null, ['class'=>'form-control', 'id'=>'other_leave']) !!}                                                
                                        </div>
                                        <div class="form-group">
