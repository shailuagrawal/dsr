                         ...
                         ?>
                            ...
                            <tr class="odd gradeX" style="{{$rowClass}}">
                                ...
                                <td>
                                	...
                                	?>
                                	<div class="tooltip-demo"><span class="projectName" id="projectName-{{$empolyee->id}}"><a href="{{url('/')}}/projectswise/dsr/{{$empolyee->project->id}}" class="{{$onBenchClass}}" data-toggle="tooltip" data-placement="left" title="Project Members ({{@$allEmpProject[$empolyee->project->id]}})">{{$empolyee->project->project_name}}</a></span>
                                ...
                                <td>
                                <span style="display:none"><?php echo date("m", strtotime($empolyee->dob)); ?></span>
                                <?php 
                                    echo date("d-M", strtotime($empolyee->dob));
                                ?>
                                </td>
                                <td>{{$empolyee->taglist}}</td>
								<!--
								<td>{{$empolyee->typing_speed}}</td>
								<td>{{$empolyee->addition_skill_english}}</td>
								<td>{{$empolyee->addition_skill_photoshop}}</td>
								<td>{{$empolyee->addition_skill_webresearch}}</td>
								<td>{{$empolyee->addition_skill_html}}</td>
								<td>{{$empolyee->addition_skill_php}}</td>
								-->
