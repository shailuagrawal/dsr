                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        @endif
	    					...
	    					<div class="row show-grid">
                                <div class="col-md-4"><strong>{!! Form::label('title', 'First Name:') !!}</strong></div>
                                <div class="col-md-8">{{$user->first_name}}</div>
                            </div>	

	    					<div class="row show-grid">
                                <div class="col-md-4"><strong> {!! Form::label('title', 'Middle name:') !!}</strong></div>
                                <div class="col-md-8">{{$user->middle_name}}&nbsp;</div>
                            </div>

    						<div class="row show-grid">
                                <div class="col-md-4"><strong> {!! Form::label('title', 'Last name:') !!}</strong></div>
                                <div class="col-md-8">{{$user->last_name}}</div>
                            </div>
    						<div class="row show-grid">
                                <div class="col-md-4"><strong> {!! Form::label('title', 'Date Of Birth:') !!}</strong></div>
                                <div class="col-md-8"><?php echo date('F j, Y', strtotime($user->dob));?></div>
                            </div>
    						<div class="row show-grid">
                                <div class="col-md-4"><strong> {!! Form::label('title', 'Sex:') !!}</strong></div>
                                <div class="col-md-8">{{$user->sex}}</div>
                            </div>
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'City:') !!}</strong></div>
                                <div class="col-md-8">{{$user->city}}&nbsp;</div>
                            </div>                                                                                                                
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Blood group:') !!}</strong></div>
                                <div class="col-md-8">{{$user->blood_group}}&nbsp;</div>
                            </div>   
                                     
                           <h3>Professional Skills</h3>
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Qualification:') !!}</strong></div>
                                <div class="col-md-8">{{$user->qualification}}&nbsp;</div>
                            </div>   
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Computer skill:') !!}</strong></div>
                                <div class="col-md-8">{{$user->computer_skill}}&nbsp;</div>
                            </div>                                                        
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Other skill / Experience:') !!}</strong></div>
                                <div class="col-md-8">{{$user->other_skill_experience}}&nbsp;</div>
                            </div>                             
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Other skill / Experience:') !!}</strong></div>
                                <div class="col-md-8">{{$user->other_skill_experience}}&nbsp;</div>
    						...
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Total Experience:') !!}</strong></div>
                                <div class="col-md-8">{{$user->total_experience}}&nbsp;</div>
                            </div>                             
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Pre Employer:') !!}</strong></div>
                                <div class="col-md-8">{{$user->pre_employer}}&nbsp;</div>
                            </div>                           
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Typing speed:') !!}</strong></div>
                                <div class="col-md-8">{{$user->typing_speed}}&nbsp;</div>
                            </div> 
    						...
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'English:') !!}</strong></div>
                                <div class="col-md-8">{{$user->addition_skill_english}}&nbsp;</div>
                            </div>                            
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'HTML:') !!}</strong></div>
                                <div class="col-md-8">{{$user->addition_skill_html}}&nbsp;</div>
                            </div>                               
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Photoshop:') !!}</strong></div>
                                <div class="col-md-8">{{$user->addition_skill_photoshop}}&nbsp;</div>
                            </div>                            
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'PHP:') !!}</strong></div>
                                <div class="col-md-8">{{$user->addition_skill_php}}&nbsp;</div>
                            </div>                            
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Webresearch:') !!}</strong></div>
                                <div class="col-md-8">{{$user->addition_skill_webresearch}}&nbsp;</div>
                            </div>                               
                                   
                                <h3>Office Use</h3>
    						<div class="row show-grid">
                                <div class="col-md-4"><strong> {!! Form::label('title', 'Employee Id:') !!}</strong></div>
                                <div class="col-md-8">{{$user->emp_id}}&nbsp;</div>
                            </div>                                                                                                                                                      
    						<div class="row show-grid">
                                <div class="col-md-4"><strong> {!! Form::label('title', 'User Name:') !!}</strong></div>
                                <div class="col-md-8">{{$user->user_name}}&nbsp;</div>
                            </div>  
    						<div class="row show-grid">
                                <div class="col-md-4"><strong> {!! Form::label('title', 'Designation:') !!}</strong></div>
                                <div class="col-md-8">{{$user->designation}}&nbsp;</div>
                            </div>  
    						<div class="row show-grid">
                                <div class="col-md-4"><strong> {!! Form::label('title', 'Company Email:') !!}</strong></div>
                                <div class="col-md-8">{{$user->email}}&nbsp;</div>
                            </div>  
    						<div class="row show-grid">
                                <div class="col-md-4"><strong> {!! Form::label('title', 'Date Of Joining:') !!}</strong></div>
                                <div class="col-md-8"><?php echo date('F j, Y', strtotime($user->date_of_joining));?>&nbsp;</div>
                            </div>  
    						<div class="row show-grid">
                                <div class="col-md-4"><strong> {!! Form::label('title', 'User Role:') !!}</strong></div>
                                <div class="col-md-8">{{$roles[$user->role_id]}}&nbsp;</div>
                            </div>  
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Working Status:') !!}</strong></div>
                                <div class="col-md-8">{{$user->working_status}}&nbsp;</div>
                            </div>  
                            <!--
    						<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Remark:') !!}</strong></div>
                                <div class="col-md-8">{{$user->remark}}&nbsp;</div>
                            </div>  
                            -->
  							<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Left On:') !!}</strong></div>
                                <div class="col-md-8"><?php echo date('F j, Y', strtotime($user->company_left_on));?>&nbsp;</div>
                            </div>  
							 <h3>Leave Status of employee</h3> 
  							<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Leave Allotted:') !!}</strong></div>
                                <div class="col-md-8">{{$user->leave_allotted}}&nbsp;</div>
                            </div> 
  							<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Leave Forwarded:') !!}</strong></div>
                                <div class="col-md-8">{{$user->leave_forwarded}}&nbsp;</div>
                            </div> 
  							<div class="row show-grid">
                                <div class="col-md-4"><strong>  {!! Form::label('title', 'Other Leave') !!}</strong></div>
                                <div class="col-md-8">{{$user->other_leave}}&nbsp;</div>
                            </div> 
  							<div class="row show-grid">
                                <div class="col-md-4"><strong>   {!! Form::label('title', 'Ready for night shift') !!}</strong></div>
                                <div class="col-md-8">{{$user->ready_for_night_shift}}&nbsp;</div>
                            </div> 
  							<div class="row show-grid">
                                <div class="col-md-4"><strong>{!! Form::label('title', 'Currently Shift') !!}</strong></div>
                                <div class="col-md-8">{{$user->working_on_shift}}&nbsp;</div>
                            </div> 
  							<div class="row show-grid">
                                <div class="col-md-4"><strong>{!! Form::label('title', 'Working On Project') !!}</strong></div>
                                <div class="col-md-8">{{$projects[$user->project_id]}}&nbsp;</div>
                            </div> 
                    ...
                    <!-- /.panel -->
                        ...
                        <div class="panel-body">
                                ...
                                {!! Form::model($user, ['method' => 'PATCH', 'action' => ['UserController@updateprofile', $user->id], 'files' => true ]) !!} 
