...
<div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Leave Browser</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
          ...
          <!-- /.row -->
            <div class="row">
					{!! Form::open(['method' => 'post', 'action' => 'UserController@leavebrowse', 'files' => true ]) !!}	
	...
	<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example1">
                        ...
                        @foreach($data as $k => $aLeave)     
                            ...
                            <tr style="background-color:<?php echo $rowColor; ?>">
                            	...
                            	<td><a href="{{url('/')}}/admin/{{$aLeave['employee_id']}}/edit">{{$aLeave['employee']}}</a></td>
